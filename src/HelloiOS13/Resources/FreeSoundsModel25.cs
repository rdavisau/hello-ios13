...
namespace HelloiOS13 {
	...
	/// </summary>
	public class FreeSoundsModel25Input : NSObject, IMLFeatureProvider
	{
		...
		public FreeSoundsModel25Input (MLMultiArray audioSamples)
		{
	...
	/// </summary>
	public class FreeSoundsModel25Output : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public FreeSoundsModel25Output (NSDictionary<NSObject, NSNumber> classLabelProbs, string classLabel)
		{
	...
	/// </summary>
	public class FreeSoundsModel25 : NSObject
	{
		readonly MLModel model;

		static NSUrl GetModelUrl ()
		{
			return NSBundle.MainBundle.GetUrlForResource ("FreeSoundsModel25", "mlmodelc");
		}

		public FreeSoundsModel25 ()
		{
			NSError err;
		...
		FreeSoundsModel25 (MLModel model)
		{
			this.model = model;
		}

		public static FreeSoundsModel25 Create (NSUrl url, out NSError error)
		{
			if (url == null)
			...
			return new FreeSoundsModel25 (model);
		}

		public static FreeSoundsModel25 Create (MLModelConfiguration configuration, out NSError error)
		{
		...
		public static FreeSoundsModel25 Create (NSUrl url, MLModelConfiguration configuration, out NSError error)
		{
			if (url == null)
				throw new ArgumentNullException (nameof (url));
		...
		public FreeSoundsModel25Output GetPrediction (FreeSoundsModel25Input input, out NSError error)
		{
			if (input == null)
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public FreeSoundsModel25Output GetPrediction (MLMultiArray audioSamples, out NSError error)
		{
			var input = new FreeSoundsModel25Input (audioSamples);
		...
		/// <param name="options">prediction options</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public FreeSoundsModel25Output GetPrediction (MLMultiArray audioSamples, MLPredictionOptions options, out NSError error)
		{
			var input = new FreeSoundsModel25Input (audioSamples);
