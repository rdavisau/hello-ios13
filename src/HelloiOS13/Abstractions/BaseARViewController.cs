...
namespace ARKitMeetup.Demos.D1
{
    ...
    public class BaseARViewController : BaseViewController
    {
        ...
        private void SetupDebugOverlay()
        {
            ...
            PositionLabel = new UILabel { Font = UIFont.SystemFontOfSize(MiniFont), AdjustsFontSizeToFitWidth = true, TextAlignment = UITextAlignment.Center, Text = "Smaaaaash", TextColor = UIColor.White, TranslatesAutoresizingMaskIntoConstraints = false };
        ...
        private Task DisplayPreparePrompt() => Task.CompletedTask;
