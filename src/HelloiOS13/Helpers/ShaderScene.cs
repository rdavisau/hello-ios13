...
{
    public class DisplayShaderSceneViewController : UIViewController
    {     
        public override void ViewDidLoad()
        {
            ...
            var skView = new SKView(View.Frame) { ShowsFPS = true, PreferredFramesPerSecond = 120 };
    ...
    public class ShaderScene : SKScene
    {
        ...
        public static ShaderScene Random(int num = -1)
        {
            ...
            var bg = num != -1 ? bgs[num % bgs.Length] : bgs[_r.Next(0, bgs.Length)]; 
